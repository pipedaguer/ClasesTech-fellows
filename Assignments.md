...
You will be taking a unified coding test (~ 1 hour) the 2nd week of March as a form of maintaining your place in the program! What we can share right now is that this test will cover the following:
* Typescript
* Python
* SQL
* API interfaces
